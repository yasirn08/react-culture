      ...
      <React.Fragment>
        ...
        <div className="main-cont">
          <Navbar color="" light expand="md">
            <NavbarBrand href="/">
              {" "}
              <img src="../static/culture-logo-1.png" height="40px" />
            </NavbarBrand>
          ...
          <Container className="mainhead1">
            <h className="mainhead" style={{ color: "white" }}>
              Created for the curious
            </h>
          </Container>
          <InputGroup className="searchbar">
            <Input placeholder="    Discover a city" className="form-cc" />
